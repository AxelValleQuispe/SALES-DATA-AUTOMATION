...
RUTA_SALIDA = Path("data/processed/service_sales.csv")


def analizar_por_servicio(df):
    """Calcula indicadores de ventas por servicio."""
...
def main():
    ...
    print("=" * 50)
    print("ANÁLISIS DE VENTAS POR SERVICIO")
    print("=" * 50)

    df = pd.read_csv(RUTA_ENTRADA)

    resumen = analizar_por_servicio(df)
    ...
    print("\nAnálisis por servicio finalizado correctamente.")
